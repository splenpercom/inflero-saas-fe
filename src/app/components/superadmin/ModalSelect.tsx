  ...
  return (
    <div className={cn("relative", className)} ref={anchorRef}>
      <button
        ...
        className="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white hover:border-orange-300 dark:hover:border-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-300 dark:focus:border-orange-600 transition-all flex items-center justify-between gap-2"
      >
        <span
          className={cn(
            "truncate",
            ...
            <div className="max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700">
              {options.map((option) => (
                <button
                  ...
                  className={cn(
                    "w-full px-4 py-2.5 text-sm text-left hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors flex items-center justify-between gap-2",
                    value === option
