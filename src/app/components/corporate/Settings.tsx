  ...
  const navItemClass = (section: SettingsSection) =>
    `w-full text-left px-3 py-2 rounded-md text-xs transition-colors ${
      activeSection === section
        ? "bg-[#14b8a6]/10 text-[#14b8a6] font-medium"
    ...
    <div className="flex-1 overflow-auto bg-gray-50 dark:bg-gray-950">
      <div className="p-4 sm:p-4 xl:p-6 2xl:px-8 py-4">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          {/* Left sidebar */}
          <nav className="w-full md:w-56 shrink-0 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-2 h-fit">
            <div>
              <button
                type="button"
                onClick={() => setCompanyNavOpen(!companyNavOpen)}
                className="w-full flex items-center justify-between px-3 py-2 rounded-md text-xs font-medium text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors"
              >
                <span>{pt("Company Settings", "Şirkət Parametrləri")}</span>
                {companyNavOpen ? (
          ...
          {/* Right content panel */}
          <div className="flex-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg overflow-visible min-w-0">
                ...
                <div className="px-4 pb-4 space-y-5 pt-4">
                                ...
                                >
                                  ...
                                  <td className="px-3 py-2">
                                    <ModernSelect
                                      ...
                                      onChange={(value) => {
                                        const v = value as CommissionDraft["commissionType"];
                                      ...
                                      minWidth={120}
                                      options={[
                                        { value: "", label: pt("None", "Yox") },
                                        { value: "FIXED", label: pt("Fixed (AZN)", "Sabit (AZN)") },
                                        { value: "PERCENT", label: pt("Percent (%)", "Faiz (%)") },
                                      ]}
                                    />
                                  </td>
                                  <td className="px-3 py-2">
                  ...
                  <div className="flex items-start justify-between gap-4 pt-2 border-t border-gray-100 dark:border-gray-800">
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 mt-0.5">
                        {pt(
                          "When on, POS shows Send to Production, and Orders shows the production column and filter.",
                          "Aktiv olduqda POS-da İstehsala göndər düyməsi və Sifarişlərdə istehsal sütunu/filtri görünür.",
                        )}
                      </p>
                    </div>
                    <button
