    ...
    <div className="flex-1 overflow-auto bg-gray-50 dark:bg-gray-950">
      <div className="p-4 sm:p-4 xl:p-6 2xl:px-8 py-4">
        ...
        <div className="flex justify-end gap-2 mb-4">
          ...
          {canCreate && !isDemo && (
            <button onClick={handleAddIncome} className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-[#14b8a6] hover:bg-[#0d9488] text-white rounded-lg font-medium transition-colors">
