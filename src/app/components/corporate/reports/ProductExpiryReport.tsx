...
export function ProductExpiryReport() {
  ...
  const productExpiryItems: ProductExpiryItem[] = [
    ...
    },
    {
      ...
      manufacturedDate: "25 Dec 2024",
      expiredDate: "22 Dec 2026",
    },
    {
      id: "3",
      sku: "PT003",
    ...
    },
    {
      ...
      manufacturedDate: "30 Dec 2024",
      expiredDate: "26 Dec 2026",
    },
    {
      id: "5",
      sku: "PT005",
    ...
    },
    {
      ...
      manufacturedDate: "15 Dec 2024",
      expiredDate: "30 Dec 2026",
    },
    {
      id: "8",
      sku: "PT008",
  ...
  const {
    ...
    data: productExpiryItems,
    itemsPerPage: DEFAULT_REPORT_PAGE_SIZE,
    resetKey: `${selectedStore}|${selectedCategory}|${selectedBrand}|${selectedProduct}|${preset}|${customFrom}|${customTo}`,
  });
