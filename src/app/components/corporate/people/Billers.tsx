...
export function Billers() {
  ...
  const billers: Biller[] = [
    ...
    },
    {
      ...
      code: "BL002",
      name: "Sarah Johnson",
      email: "sarah.j@finbilling.com",
      phone: "+12345678902",
      company: "FinBilling Corp",
      status: "Active",
    },
    {
      id: "3",
      code: "BL003",
      name: "Michael Brown",
      email: "m.brown@quickbill.com",
      phone: "+12345678903",
      company: "QuickBill Services",
      status: "Active",
    },
    {
      id: "4",
      code: "BL004",
      name: "Emily Davis",
      email: "emily.d@probill.com",
      phone: "+12345678904",
      company: "ProBill Solutions",
      status: "Inactive",
    },
    {
      id: "5",
      code: "BL005",
      name: "David Wilson",
      email: "d.wilson@smartbill.com",
      phone: "+12345678905",
      company: "SmartBill Group",
      status: "Active",
    },
    {
      id: "6",
      code: "BL006",
      name: "Lisa Anderson",
      email: "lisa.a@fastbill.com",
      phone: "+12345678906",
      company: "FastBill Partners",
      status: "Active",
    },
  ];
  ...
  const handleRefresh = () => {
    alert(tr("Kassir/Hesabçılar yenilənir...", "Refreshing billers..."));
  };
  ...
  const handleSaveBiller = (billerData: any) => {
    alert(tr("Ödəyici uğurla əlavə edildi!", "Biller added successfully!"));
  };

  const handleView = (id: string) => {
    alert(tr(`Kassir/Hesabçı ${id} baxılır`, `View biller ${id}`));
  };

  const handleEdit = (id: string) => {
    alert(tr(`Kassir/Hesabçı ${id} redaktə edilir`, `Edit biller ${id}`));
  };

  const handleDelete = async (id: string) => {
    if (await askConfirm({
      title: tr("Silmə təsdiqi", "Confirm deletion"),
      message: tr("Bu Kassir/Hesabçını silmək istədiyinizə əminsiniz?", "Are you sure you want to delete this biller?"),
      variant: "danger",
    })) {
      alert(tr(`Kassir/Hesabçı ${id} silinir`, `Delete biller ${id}`));
    }
  };
      ...
      <div className="p-4 sm:p-4 xl:p-6 2xl:px-8 py-4">
        ...
        <div className="mb-4">
          <h1 className="text-lg sm:text-lg xl:text-xl 2xl:text-2xl font-semibold text-gray-900 dark:text-white">
            {tr("Kassir/Hesabçılar", "Billers")}
          </h1>
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            {tr("Kassir və hesabçı tərəfdaşlarınızı idarə edin", "Manage your billing partners")}
          </p>
        </div>
        ...
        <div className="flex justify-end gap-2 mb-4">
          ...
          >
            ...
            <span>{tr("Kassir/Hesabçı Əlavə Et", "Add Biller")}</span>
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">
                      <span className={cn(
                        ...
                        {translateStatus(biller.status)}
                      </span>
                    </td>
                    <td className="px-3 py-2 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => handleView(biller.id)}
