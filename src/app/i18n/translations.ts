...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    // Header
    ordersBadge: "Orders",
    reservationsBadge: "Reservations",
    ...
    newReservationDescription: "Fill in the details to create a new reservation.",
    assignTableDescription: "Select a table to assign to this reservation.",
    ...
    settingsPage: {
      ...
      hideNewReservationDesc: "Enable this to hide new reservation widget from top navigation.",
      ...
      reservationConfirmationDesc: "Customer will receive an email after making the reservation.",
      newReservationReceived: "New Reservation Received",
      newReservationReceivedDesc: "Restaurant admin will receive an email when a new reservation is made by the customer.",
      ...
      // Reservation Tab
      reservationSubtitle: "Configure reservation settings and time slots for your restaurant",
      reservationSettings: "Reservation Settings",
      enableAdminReservations: "Enable Admin Reservations",
      enableAdminReservationsDesc: "Allow staff to create reservations through the admin panel",
      enableCustomerReservations: "Enable Customer Reservations",
      enableCustomerReservationsDesc: "Allow customers to make reservations through the customer site",
      minimumPartySize: "Minimum Party Size",
      minimumPartySizeDesc: "Set the minimum number of guests required for a reservation",
      disableSlotMinutes: "Disable Slot Minutes",
      disableSlotMinutesDesc: "Set how many minutes before a time slot that bookings should be disabled. This only applies to reservations for today",
      minutes: "Minutes",
      ...
      defaultTableReservationStatus: "Default Table Reservation Status",
      defaultTableReservationStatusDesc: "Select the default status for new reservations.",
